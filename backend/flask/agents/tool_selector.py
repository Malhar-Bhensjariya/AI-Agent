...
1 — For data editing (e.g., add/remove rows/columns, set a cell, update a row)
2 — For data transformation (e.g., filter rows, sort data, rename columns, clean values)
3 — For visualizations (e.g., generate bar chart, pie chart, or line plot)
4 — For anything else, including unclear or general prompts

ONLY reply with 1, 2, 3, or 4. Do not include any explanation. No extra text or punctuation.""")
    ...
    try:
        ...
        if selection not in {"1", "2", "3", "4"}:
            return "4"  # Default fallback to chat agent
